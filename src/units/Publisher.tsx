    ...
    new Map([
        [
            FMT.PLAIN,
            {
                ...
                message: "Value cannot be formatted.",
            },
        ],
        [
            FMT.JSON,
...
const Publisher: React.FC<PublisherProps> = ({
    ...
    const onFinish = (formvalues: PublisherValues) => {
        ...
        const format: ValueFormat =
            FMTValueFormat.get(values.fmt ?? fmt)?.format ??
            StringValueFormat();
