...
const ContentConnectAbout: React.FC<{ form: FormInstance<ConnectInfoForm> }> =
  ({ form }) => {
    return (
      <>
        <Link
        ...
        <Typography>
          ...
          <Paragraph>
            ...
            subscribe to topics or you can use MYHELLOIOT as a client platform
            to create your own dashboard. MYHELLOIOT is a{" "}
            <Link
